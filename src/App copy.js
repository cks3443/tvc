...
function App() {
  ...
  useEffect(() => {
    const vc = FirebaseFirestoreService.readAllDocument("voca");
    setVocas([...vc]);
  }, []);
      ...
      {!login ? (
        ...
        <>
          <div className='flex flex-row'>
            ...
            <button
              class='bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded ml-4 mr-4'
          ...
          <button
            class='w-14 text-2xl h-14 mt-10 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex justify-center items-center'
            onClick={() => {
              if (addState) {
                plusBtnHandler();
              } else {
